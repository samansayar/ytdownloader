    ...
    return (
        <div className='w-full'>
            <Link  href={`/profile/${item.channel_id}`}>
                <div className='flex w-full dark:bg-slate-700 bg-white/80 h-20 cursor-pointer px-4 py-2'>
                    ...
                    <div className="flex flex-col w-full mx-4 justify-center">
                        <p className='lg:text-sm text-sm font-light w-full'>{item?.channel_title.substring(0, 15)}...</p>
