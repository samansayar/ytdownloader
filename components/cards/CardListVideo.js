...
export default function CardListVideo() {
  return (
    <div  className="flex transition duration-150 cursor-pointer hover:bg-white py-1 justify-start items-center space-y-2">
      ...
      <div className='w-[90%] h-full flex justify-start'>
        ...
        <div className="relative">
          {/* <!-- Image Video --> */}
          <a href="#">
            <Image src="/images/tumbnail.jpg" width="100" height={'65'}
             className="w-24 object-cover h-16" alt="image profile" />
          </a>

          <p className="absolute right-1 bottom-4 bg-gray-900 text-gray-100 text-[11px] px-2 rounded-sm py-0.5">1:15</p>
        </div>
